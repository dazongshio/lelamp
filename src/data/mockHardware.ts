...
export const hardwareDevices: HardwareDevice[] = [
  ...
  { key: "projection_available", label: "投影/显示 (Projector)", status: "unavailable", note: "HDMI-1 未检测到显示设备" },
...
export const hardwareEvents = [
  ...
  { time: "14:26:11", title: "Projection 不可用", status: "unavailable", detail: "未检测到 HDMI 显示设备" },
