# LeLamp/OpenClaw AI Product Design Prompt

Use this prompt when asking an agent to turn the LeLamp/OpenClaw prototype into
a structured AI product design proposal.
